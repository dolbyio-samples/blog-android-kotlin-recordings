...
const clientAuthUrl = 'https://session.voxeet.com/v1/oauth2/token';
const bearerAuthUrl = 'https://api.voxeet.com/v1/auth/token';
var tokenType = "client"
...
async function fetchToken() {
  try {
    let url = (tokenType === "client") ? clientAuthUrl : bearerAuthUrl;
...
exports.handler = async (event) => {
  let isValid = false;
  tokenType = (event.headers.authtoken != undefined) ? event.headers.authtoken : "client" // client or bearer
